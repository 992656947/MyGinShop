...
// 2、定义key 和过期时间
var jwtKey = []byte("myToken.con") //byte类型的切片
...
func (con ApiController) AddressList(c *gin.Context) {
	...
	tokenStr := "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVaWQiOjIzLCJleHAiOjE3MjQxMTY3ODMsImlzcyI6Im15VG9rZW4ifQ.NkCZyHhVdCRB2E-3yBlZaOv3g1QtknNUsea7cxp6MAE"
	//if len(tokenData) > 0 {
